...
@section('content')
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control d-inline-block text-sm" name="name" value="{{ (old('name')) ?  old('name') : $user->name }}" placeholder="Enter Username here">
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control d-inline-block text-sm" name="email" value="{{(old('email')) ?  old('email') : $user->email }}" placeholder="Enter email here">
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-9">
               ...
               <select class="custom-select form-control" id="roles" name="role">
