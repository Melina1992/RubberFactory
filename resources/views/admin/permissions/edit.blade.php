                ...
                <div class="col-md-5 offset-2">
                    <div class="card card-info">
                        <div class="card-header">
                            <h5>Edit Permission
                                <a href="{{ asset('permissions') }}" class="btn btn-warning btn-sm float-right text-dark text-sm text-bold">View All Permissions</a>
                            </h5>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="{{ route('permissions.update', $permission->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control d-inline-block text-sm" name="name" value="{{ (old('name')) ?  old('name') : $permission->name }}" placeholder="Enter permission here">
                                            <span class="text-xs text-gray">Ex: employee_edit</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
